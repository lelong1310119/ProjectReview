        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InstructorId = table.Column<long>(type: "bigint", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    ProcessEnd = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProcessUser", x => new { x.ProcessId, x.UserId });
                    table.ForeignKey(
                        name: "FK_ProcessUser_Process",
                        column: x => x.ProcessId,
                        principalTable: "Process",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProcessUser_User",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Document_CreateUserId",
                table: "Document",
                column: "CreateUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Document_DensityId",
                table: "Document",
                column: "DensityId");
