...
namespace ProjectReview.Controllers
{
    public class ProfilesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Symbol,Title,Expiry,Deadline,Status,OrderBy,CreateDate,CreateUserId")] Profile profile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,Symbol,Title,Expiry,Deadline,Status,OrderBy,CreateDate,CreateUserId")] Profile profile)
        {
            if (id != profile.Id)
            {
                return NotFound();
